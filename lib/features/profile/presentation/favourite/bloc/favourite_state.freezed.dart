...
mixin _$FavoritesState {
 ...
 FavoritesStatus get status; List<ProductEntity> get items; String? get errorMessage;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FavoritesState&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other.items, items)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}
...
@override
String toString() {
  return 'FavoritesState(status: $status, items: $items, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 FavoritesStatus status, List<ProductEntity> items, String? errorMessage
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( FavoritesStatus status,  List<ProductEntity> items,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FavoritesState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( FavoritesStatus status,  List<ProductEntity> items,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _FavoritesState():
return $default(_that.status,_that.items,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( FavoritesStatus status,  List<ProductEntity> items,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _FavoritesState() when $default != null:
return $default(_that.status,_that.items,_that.errorMessage);case _:
  return null;
...
class _FavoritesState implements FavoritesState {
  const _FavoritesState({this.status = FavoritesStatus.initial, final  List<ProductEntity> items = const [], this.errorMessage}): _items = items;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FavoritesState&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other._items, _items)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}
