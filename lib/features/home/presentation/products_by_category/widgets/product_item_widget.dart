...
class ProductItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bool isInCart = context.watch<CartBloc>().state.items.any(
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Column(
                    ...
                    children: product.stickerNames.map((name) {
                      final backgroundColor =
                      getStickerColor(name);
                      return Container(
                ...
                Positioned(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 6),
                      SvgPicture.asset('assets/images/compare_icon.svg',
                      ),
                    ],
                  ),
                ),
                Positioned(
                  ...
                  child: Row(
                    crossAxisAlignment:
                    CrossAxisAlignment.start,
                    children: product.saleMonthImages.map((image) {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      SvgPicture.asset('assets/images/review_star_disable.svg'),
                      SizedBox(width: 6),
                      Text(
                        "Sharh yo'q",
                        style: const TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        "${formatter.format(product.salePrice)} so'm",
                        style: const TextStyle(
                          fontFamily: 'Roboto',
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(12),
                              border: Border.all(
                                color: isInCart ? AppColors.onPrimary : AppColors.primary,
                                width: 2,
                              )
                          ),
                          child: Center(
                            child: isInCart
                                ? SvgPicture.asset('assets/images/basket_added.svg', width: 17, height: 17)
                                : SvgPicture.asset(
