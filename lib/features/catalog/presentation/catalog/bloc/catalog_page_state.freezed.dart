...
part of 'catalog_page_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CatalogPageState);
}
...
/// @nodoc
class $CatalogPageStateCopyWith<$Res>  {
$CatalogPageStateCopyWith(CatalogPageState _, $Res Function(CatalogPageState) __);
}


/// Adds pattern-matching-related methods to [CatalogPageState].
extension CatalogPageStatePatterns on CatalogPageState {
...
class _Initial implements CatalogPageState {
  const _Initial();
...
@override
String toString() {
  return 'CatalogPageState.initial()';
}
...
class _Loading implements CatalogPageState {
  const _Loading();
...
@override
String toString() {
  return 'CatalogPageState.loading()';
}
...
class _Loaded implements CatalogPageState {
...
/// Create a copy of CatalogPageState
...
@override
String toString() {
  return 'CatalogPageState.loaded(categories: $categories)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $CatalogPageStateCopyWith<$Res> {
...
class _Error implements CatalogPageState {
...
@override
String toString() {
  return 'CatalogPageState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $CatalogPageStateCopyWith<$Res> {
